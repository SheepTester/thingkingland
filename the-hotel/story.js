...
"initi":["The lights are off. You can hear moans from somewhere.",1,["Objective: turn on the lights.","lights","Objective: investigate the moans.","moan","Objective: find the exit.","exit",]],
	"lights":["You feel around the wall for the light switch and find out the wall is covered in spikes. Your hand falls off.",1,["Use the other hand.","otherHand","Continue feeling the wall.","wallFeel",]],
		"otherHand":["Your other hand falls off.",1,["Continue feeling the wall with your face.","facewall","Eat your hand.","whichOne",]],
			...
			"whichOne":["You are faced with a very difficult decision: which hand to eat.",1,["Left","whatever","Right","whatever",]],
				"whatever":["You grow 2 times larger and are now crouching. Your hands regenerate and the other hand disappears. You here some large objects moving around before the lights magically turn on. There is nothing in the room except for the spikes on the wall and the lights on the ceiling. What to do now?",1,["Yodel.","yodelly","Stand up.","oucch","Break the light.","break",]],
					"yodelly":["The excess fat escaped through your mouth and you returned to your normal size. You see two differently colored trapdoors beneath where your feet where.",1,["Go through the green trapdoor.","gredoor","Go through the magenta trapdoor.","magdoor",]],
						"gredoor":["You find yourself in front of two doors and two guards. A sign says \"One guard always lies, one guard always tells the truth.",1,["Ask what the other one would say if he asked them which door he would want to go to.","nope","Go through the left door.","hell","Go through the right door.","heaven",]],
						...
						"magdoor":["You find yourself in a kitchen.",1,["Investigate the refridgerator.","fridge","Investigate the microwave.","microwave","Investigate the stove.","stove",]],
							...
							"fridge":["There are only two foods in the refridgerator. You are hungry.",1,["Eat the sushi.","sushi","Eat the McDonald's hamburger.","burger",]],
								...
								"burger":["You hear a murderous voice say, \"Yes, yes, continue eating. And do not turn around.\"",1,["Continue eating.","goodjob","Turn around.","badjob",]],
									...
									"teleport":["You become face-to-face with a man with a knife and a magic lamp. The man asks you which one you want. You are too fat to move your body and so you just point.",1,["Point at the knife.","magic","Point at the magic lamp.","notmagic",]],
							...
							"microwave":["The microwave is locked with a padlock that has a number input on it.",2,666,"unlock","wellno"],
								...
								"unlock":["The microwave opens and you find a marshmellow in the microwave. It is labeled, \"Wait 5 minutes without eating this marshmellow for a second marshmellow!\"",1,["Wait 5 minutes.","magicellow","Eat the marshmellow.","foodpoison","Microwave the marshmellows.","entrenum",]],
									...
									"magicellow":["5 minutes later, another marshmellow appears.",1,["Eat a marshmellow.","foodpoison","Inspect the marshmellows.","read",]],
										"read":["One of the marshmellows have the digits 4, 3, 5, and 6 with a little doodle of a sheep in between each digit. The other marshmellow has a tiny red button.",1,["Press the button.","catkilled","Eat a marshmellow.","foodpoison",]],
					...
					"phonie":["The phone requires a passcode. The lock screen background has sheep doodles on it.",2,4356,"deniedaccess","overheat"],
						...
						"deniedaccess":["The phone opens up to Google Chrome. The top UI bar thing isn't displaying for some reason. There is no internet connection, so it is showing that fun page with the dinosaur. There is no spacebar, though, so you can't play that fun game to pass the time.",0,"aww"],
						"aww":["You need to tap on something.",1,["Shake the phone.","undo","Say, \"Hey, Siri.\"","hi","Swipe up.","up","Swipe down.","down",]],
							...
							"memes":["The page automatically reloads and presents you with links to what look like IP addresses.",1,["Tap on the link that starts with a 9.","nine","Tap on the link that starts with a 3.","three",]],
								...
								"three1":["What to do?",1,["Click on the left one that has the 2008 in it.","nooo","Click on the right one that has the 8002 in it.","nooo","Do the hokey pokey.","shrink",]],
									...
									"shrink":["You magically shrink back to your normal size, but now the phone is too heavy for you to carry. You drop it and it cracks. You can't read what it says, but the IP-link things are still there.",1,["Tap the left one.","blablano","Tap the right one.","blablaok",]],
	...
	"moan":["You see a set of glowing red eyes.",1,["Offer to dance.","bailar","Offer to have a conversation.","conversar","Offer to shake hands.","shakar",]],
		...
		"so":["How should you peek inside?",1,["Take a quick peek.","quickly","Ask, \"Who's there?\"","ask","Wait until morning instead.","wait",]],
			...
			"andthen":["You find a knife on the floor and use it to make a hole in your stomach. You need to quickly throw an internal organ before you die of blood loss.",1,["The heart.","heart","The liver.","organ","The stomach.","organ","The lungs.","lung","The kidneys.","organ","The intestines.","organ",]],
									...
									"lefto":["You come across another fork.",1,["Go left.","lefti","Go right.","whoops",]],
										"lefti":["You are presented with three buttons.",1,["Press the blue button.","bloo","Press the red button.","redd","Press the green button.","grin",]],
											...
											"grin":["Which statement is true?",1,["I am dead.","falsee","I am a heartless dog.","truee",]],
												...
												"truee":["You turn into a dog without a heart. Your vision is blurry. You see three blurry objects. The one on the left looks like a cucumber, the middle one looks like a potato, and the right one looks like a heart. There is a hole where your heart is.",0,"organtime"],
												"organtime":["Which one to put in your heart-hole?",1,["The left one.","pickle","The middle one.","pumper","The right one.","valentine","End my life please.","umok",]],
													...
													"pumper":["You are in great pain but you can see clearly again. There is a dog-shaped hole on the wall. Above it is the number 40 and a picture of food.",1,["Jump through.","jumpscape","Right now might be a good time to die.","umok",]],
		...
		"unlockDoor":["The door requires a key.",1,["Break down the door.","splinter","Eat the door.","nutrition","Go through the door as if it doesn't exist.","collide",]],
			...
			"nutrition":["You obtain night vision but it doesn't work very well. There are four doors.",1,["Go through the door.","door1","Go through the door.","door2","Go through the door.","door3","Go through the door.","door4",]],
				...
				"door2":["You quickly hide as you hear someone being dragged into the room.",1,["Take a peek.","peeking","Listen.","listening","Throw a rock.","throwing",]],
					...
					"throwing":["A person walks over to inspect the objects. You throw a knife at him. He falls over and appears to die. Across the room there is a supposedly dead person.",1,["Inspect the man you killed.","tukill","Inspect the person he killed.","hekill",]],
